<template>
  <section>
      ...
      <l-map
        ...
        <l-marker v-for="pothole in potholes"
          ...
          <l-popup class="info">
            ...
            <p><span>Latitud: </span>{{ pothole.lat }}</p>
            <p><span>Longitud: </span>{{ pothole.lng }}</p>
            <p><span>Actualizado: </span>{{ pothole.date }} </p>
    ...
    <!--Statistics -->
    <Statistics :potholes="potholes" v-if="potholes"></Statistics>
  </section>
</template>
